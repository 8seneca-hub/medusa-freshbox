import type { AdditionalData } from "@freshbox-medusa/framework/types"
import { isDefined, PromotionActions } from "@freshbox-medusa/framework/utils"
import {
  createHook,
  createWorkflow,
  transform,
 ...
 *
 * ```ts
 * import { refreshCartItemsWorkflow } from "@freshbox-medusa/medusa/core-flows";
 * import { StepResponse } from "@freshbox-medusa/workflows-sdk";
 *
