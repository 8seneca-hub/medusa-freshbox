import type { AdditionalData, ProductTypes } from "@freshbox-medusa/framework/types"
import { ProductCollectionWorkflowEvents } from "@freshbox-medusa/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
