...
describe("getResolvedPlugins | relative paths", () => {
  test("resolve configured plugins", async () => {
    await fs.createJson("node_modules/@freshbox-medusa/draft-order/package.json", {
      name: "@freshbox-medusa/draft-order",
      version: "1.0.0",
    })
    ...
    expect(plugins).toEqual(
      expect.arrayContaining([
        {
          id: "@freshbox-medusa/draft-order",
          modules: [],
          name: "@freshbox-medusa/draft-order",
          options: {},
          resolve: path.join(
            fs.basePath,
            "node_modules/@freshbox-medusa/draft-order/.medusa/server/src"
          ),
          version: "1.0.0",
        },
        {
