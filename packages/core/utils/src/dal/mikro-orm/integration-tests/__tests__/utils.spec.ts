import { MikroORM } from "@freshbox-medusa/deps/mikro-orm/core"
import {
  defineConfig,
  SqlEntityManager,
...
jest.mock("@freshbox-medusa/deps/mikro-orm/core", () => ({
  ...jest.requireActual("@freshbox-medusa/deps/mikro-orm/core"),
