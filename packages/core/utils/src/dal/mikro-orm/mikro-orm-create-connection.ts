import { Filter as MikroORMFilter } from "@freshbox-medusa/deps/mikro-orm/core"
import { TSMigrationGenerator } from "@freshbox-medusa/deps/mikro-orm/migrations"
import { ModuleServiceInitializeOptions } from "@freshbox-medusa/types"
...
const expectedMigrationsImportStatement =
  'import { Migration } from "@freshbox-medusa/framework/mikro-orm/migrations"'
...
export async function mikroOrmCreateConnection(
  ...
  const { MikroORM, defineConfig } = await import(
    "@freshbox-medusa/deps/mikro-orm/postgresql"
  )
