...
describe("generateContainerTypes", function () {
  it("should create file with types for provided modules", async function () {
    await generateContainerTypes(
      {
        cache: {
          __definition: {
            key: "foo-cache",
            label: "Cache",
            defaultPackage: "@freshbox-medusa/foo-cache",
            resolvePath: "@freshbox-medusa/foo-cache",
    ...
    expect(await fileSystem.contents("modules-bindings.d.ts"))
      ...
      "import type FooCache from '@freshbox-medusa/foo-cache'

      declare module '@freshbox-medusa/framework/types' {
  ...
  it("point inbuilt packages to their interfaces", async function () {
    ...
    expect(await fileSystem.contents("modules-bindings.d.ts"))
      .toMatchInlineSnapshot(`
      "import type { ICacheService } from '@freshbox-medusa/framework/types'
