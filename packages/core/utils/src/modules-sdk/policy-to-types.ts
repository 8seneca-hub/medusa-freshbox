 ...
 * - "policy-bindings.d.ts" - Module augmentation for @freshbox-medusa/framework/utils
 *
...
// Module augmentation for @freshbox-medusa/framework/utils
// Types and globals are defined in policy-types.d.ts
declare module "@freshbox-medusa/framework/utils" {
