import { INotificationProvider, NotificationTypes } from "@freshbox-medusa/types"
 ...
 *
 * ```ts
 * import { AbstractNotificationProviderService } from "@freshbox-medusa/framework/utils"
