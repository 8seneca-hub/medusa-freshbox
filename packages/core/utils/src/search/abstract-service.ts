import { SearchTypes } from "@freshbox-medusa/types"
 ...
 *  from the `@freshbox-medusa/utils` package.
 *
 ...
 * import { AbstractSearchService } from "@freshbox-medusa/utils"
 *
  ...
  implements SearchTypes.ISearchService
{
   ...
   * @example
   * // ...
   * import { ProductService } from "@freshbox-medusa/medusa"
   *
