...
import { Migrator } from "@freshbox-medusa/framework/migrations"
import { MedusaAppOutput } from "@freshbox-medusa/framework/modules-sdk"
...
import { createDefaultsWorkflow } from "@freshbox-medusa/core-flows"
...
class MedusaTestRunner {
  ...
  private async setupApplication(): Promise<void> {
    const { container, MedusaAppLoader } = await import("@freshbox-medusa/framework")
  ...
  public async beforeEach(): Promise<void> {
    ...
    try {
      const { MedusaAppLoader } = await import("@freshbox-medusa/framework")
