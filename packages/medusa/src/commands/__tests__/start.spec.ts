import * as utils from "@freshbox-medusa/framework/utils"
...
jest.mock("@freshbox-medusa/framework/config", () => {
  return {
    configManager: {
      config: {},
    },
...
describe("start", () => {
  beforeEach(() => {
    jest.clearAllMocks()
    jest.doMock("@freshbox-medusa/framework/utils", () => ({
      ...jest.requireActual("@freshbox-medusa/framework/utils"),
