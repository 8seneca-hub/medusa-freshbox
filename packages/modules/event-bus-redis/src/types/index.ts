...
// import type { EventBusEventsOptions } from "@freshbox-medusa/types"

// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import type { ModuleOptions } from "@freshbox-medusa/types"
...
declare module "@freshbox-medusa/types" {
  interface ModuleOptions {
    "@freshbox-medusa/event-bus-redis": EventBusRedisModuleOptions
    "@freshbox-medusa/medusa/event-bus-redis": EventBusRedisModuleOptions
  }
}
